...
# Setting a colored header for the dataset selection without any gap
st.sidebar.markdown('<h4 style="color: darkturquoise; margin-bottom: 0;">🎯 SELECT DATASET</h4>', unsafe_allow_html=True)
